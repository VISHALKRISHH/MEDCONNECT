  ...
  return (
    <div className='w-full max-w-6xl m-5 '>
              ...
              : item.isCompleted
                ? <div className='flex gap-2'>
                    ...
                    <button 
                      ...
                      className='text-xs border border-primary px-2 py-1 rounded hover:bg-primary hover:text-white transition-all'
                    >
                      Upload Report
                    </button>
                  </div>
      ...
      {showUploadModal && selectedAppointment && (
        ...
        // />
        // In DoctorAppointments.jsx when rendering UploadReport
<UploadReport
  appointmentId={selectedAppointment._id}
  userId={selectedAppointment.userId}
  ...
  onClose={() => setShowUploadModal(false)}
  dToken={dToken}
  backendUrl={backendUrl} // Make sure this is correctly from context
  onSuccess={getAppointments}
/>
